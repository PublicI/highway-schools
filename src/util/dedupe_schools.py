...
input_file = '../data/schoolsandplaces.csv'
output_file = '../data/schoolsandplaces-clustered.csv'
settings_file = '../data/schoolsandplaces_learned_settings'
training_file = '../data/schoolsandplaces_training.json'
...
def readData(filename):
    ...
    with open(filename) as f:
        ...
        for row in reader:
            ...
            clean_row.append(('location',location))
            row_id = row['id']
...
for (cluster_id, cluster) in enumerate(clustered_dupes):
    ...
    cluster_d = [{k:v for (k,v) in data_d[c].items() if 'location' not in k} for c in id_set]
